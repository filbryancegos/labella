...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="entry-blog entry-post">
		<div class="entry-header">
		    <div class="entry-feature entry-video"><?php $video = wp_pizzeria_archive_video(); ?></div>
		</div>
		<!-- .entry-header -->
		...
		<div class="entry-content">
			...
			<?php  if($video) { 
				echo apply_filters('the_content', preg_replace(array('/\[embed(.*)](.*)\[\/embed\]/', '/\[video(.*)](.*)\[\/video\]/','/http[^[\ |\n]*(youtube\.|vimeo\.|wordpress\.tv)[^[\ |\n]*/i','/\[wpvideo(.*)](.*)/'), '', get_the_content(), 1)); 
			} else { 
				the_content(); 
			}
	    		wp_link_pages( array(
